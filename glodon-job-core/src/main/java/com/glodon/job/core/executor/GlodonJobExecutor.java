package com.glodon.job.core.executor;
...
import com.glodon.job.core.biz.impl.ExecutorBizImpl;
import com.glodon.job.core.handler.IJobHandler;
import com.glodon.job.core.log.GlodonJobFileAppender;
import com.glodon.job.core.thread.ExecutorRegistryThread;
import com.glodon.job.core.thread.JobLogFileCleanThread;
import com.glodon.job.core.thread.JobThread;
import com.glodon.job.core.thread.TriggerCallbackThread;
...
public class GlodonJobExecutor {
    ...
    public void start() throws Exception {
        ...
        // init logpath
        GlodonJobFileAppender.initLogPath(logPath);
    ...
    public static IJobHandler registJobHandler(String name, IJobHandler jobHandler){
        logger.info(">>>>>>>>>>> glodon-job register jobhandler success, name:{}, jobHandler:{}", name, jobHandler);
    ...
    public static JobThread registJobThread(int jobId, IJobHandler handler, String removeOldReason){
        ...
        newJobThread.start();
        logger.info(">>>>>>>>>>> glodon-job regist JobThread success, jobId:{}, handler:{}", new Object[]{jobId, handler});
