package com.glodon.job.executor.service.jobhandler;
...
/**
 * GlodonJob开发示例（Bean模式）
 *
 * 开发步骤：
 * 1、在Spring Bean实例中，开发Job方法，方式格式要求为 "public ReturnT<String> execute(String param)"
 * 2、为Job方法添加注解 "@GlodonJob(value="自定义jobhandler名称", init = "JobHandler初始化方法", destroy = "JobHandler销毁方法")"，注解value值对应的是调度中心新建任务的JobHandler属性的值。
...
public class SampleGlodonJob {
     ...
     * 1、简单任务示例（Bean模式）
     */
    @GlodonJob("demoJobHandler")
    public ReturnT<String> demoJobHandler(String param) throws Exception {
        GlodonJobLogger.log("GLODON-JOB, Hello World.");
     ...
     */
    @GlodonJob(value = "demoJobHandler2", init = "init", destroy = "destroy")
